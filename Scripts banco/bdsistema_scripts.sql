...
VALUES ('Diego S.S','diego@rede.ulbra.br','Rua X - Nº 1' ,'Bairro VWXYZ','','RS','9999-9999','DiegoSS','123456'); 
UPDATE tanalistas set login ='diego.ss' where idanalista=1;
use bdsistema;
INSERT INTO tanalistas (analista,email,endereco,bairro,cidade,estado, telefone,login,senha)
...
SELECT *FROM tchamado ;
UPDATE tanalistas set analista = "diego.ss" where idanalista = 1;
use bdsistema;
DESCRIBE tanalistas;
DESCRIBE tclientes;
...
UPDATE tanalistas set analista = 'Diego S.S' where idanalista = 1;
